...
This project was inspired by an econometrics lecture in Stata by Jesse Anttila-Hughes at the University of San Francisco. The purpose of this code is to perform a similar simulation in R.
...
2.  Repeat step 1 for 1,000 iterations and save each estimate of Beta 1 Hat. These are stored in order to visualize the distribution of after these estimates.
